...
import { BrowserRouter as Router, Routes, Route } from 'react-router-dom' // Imported Routing
...
// 🚀 FIXED/IMPORTED: InquiriesModule ko yahan bhee map access de diya taake code watertight rahe
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* --- MAIN WEBSITE ROUTE (Aapki purani website bina disturb huay yahan hai) --- */}
        <Route path="/" element={
          <div className="font-sans">
            ...
            <a href="https://wa.me/923485654503" target="_blank" className="fixed bottom-6 right-6 bg-[#25D366] text-white p-4 rounded-full shadow-2xl z-[100] hover:scale-110 transition-transform">
        ...
        {/* --- ADMIN DASHBOARD ROUTE (Jab aap /admin par jayenge to sirf ye khulega) --- */}
